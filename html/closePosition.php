...
$tradeSide=$_POST['tradeSide'];
$tradeQty=filter_input(INPUT_POST, 'tradeQty', FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) ?? null;
...
$method='POST';
$params='{"category":"linear", "symbol":"' . symbol . '", "side":"' . $tradeSide . '", "positionIdx":0, "orderType":"Market", "qty":"' . $tradeQty . '", "timeInForce":"GTC", "reduceOnly":"true"}';
